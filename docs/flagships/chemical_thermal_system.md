...
`request d685c1dea0e61f55  plan 3569744110d25b78  result bd27a1e4a77ce193`
...
[FACT] SUCCEEDED; 9 recorded provider executions; total node wall time 3.8 s (operational).
...
UNCERTAINTY
  ...
  material provenance: mechanism: GRI-Mech 3.0 bytes bound by digest (provider-bundled with Cantera); no property records for the gas
SCIENTIFIC STATUS
...
TRACE
  complete
NOTES
  the reactor-to-jacket interface is an energy balance: the water loop is handed the heat the chemistry says must be removed
