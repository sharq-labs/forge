        ...
        "phase8_compatibility": {
            ...
            "binding_checks_in_descendant_mode": {
                "contract.api": {"compares": ["frozen_digest", "frozen_count", "total_count", "experimental", "deprecated", "canonical_modules"],
                                 "citation": "tools/certification/core_freeze.py:{}".format(line_of(freeze_src, 'v.add("contract.api"'))},
                "bytes.pinned_contract_files": {"files": list(core_freeze.PINNED_CONTRACT_FILES), "binding": True,
                                                "citation": "tools/certification/core_freeze.py:{}".format(line_of(freeze_src, 'v.add("bytes.pinned_contract_files"'))},
                "experimental.visibly_classified": {"citation": "tools/certification/core_freeze.py:{}".format(line_of(freeze_src, 'v.add("experimental.visibly_classified"'))},
                "certificate.verifies": {"citation": "tools/certification/core_freeze.py:{}".format(line_of(freeze_src, 'v.add("certificate.verifies"'))},
            },
