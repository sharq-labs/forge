...
SUPPLEMENT: dict[tuple[str, str], dict] = {
    ...
    # electrical.material Debye conditions: no supplement. Under the lead's
    # declaring-is-asserting rule (audit CAP-05) their Contract Integrity
    # clause "UNKNOWN unless the material declares debye_temperature" is still
    # exactly true; a declared non-elemental class is an additional UNKNOWN
    # route, stated in the condition text.
