...
def test_verification_round_trip_rederives_decision():
    r=VerificationReport(VerificationDecision.INSUFFICIENT_INDEPENDENCE,(RouteComparison("p","v",True),),(IndependenceEvidence("p","v",IndependenceLevel.PARTIAL,("shared",)),))
