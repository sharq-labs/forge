...
INVARIANTS: dict[str, tuple[tuple[str, str], ...]] = {
    "1. UNKNOWN can never improve an answer": (
        ("claims/test_quantitative_uq.py", "test_every_rule_failure_is_unknown_never_zero"),
        ("claims/test_quantitative_uq.py", "test_a_refused_level_makes_the_channel_unknown"),
        ("claims/test_sensitivity_robustness_challenge.py", "test_a_domain_end_is_unknown_beyond_not_holds"),
    ),
    "2. removing evidence can never increase assurance": (
        ("claims/test_quantitative_uq.py", "test_removing_uq_evidence_cannot_improve_the_verdict"),
        ("claims/test_impact_replay.py", "test_an_edit_with_a_recomputed_digest_is_still_refused"),
    ...
    "3. caller assertions are not evidence": (
        ("claims/test_external_evidence.py", "test_an_unpinned_measurement_is_weak_however_good_it_looks"),
        ("claims/test_quantitative_uq.py", "test_input_distributions_are_declarations_bound_to_stated_values"),
        ("claims/test_evidence_policy.py", "test_consequence_is_stated_never_inferred"),
    ),
    "4. planner output is not evidence": (
        ("claims/test_evidence_gaps_next_experiment.py", "test_recommendations_address_real_gaps_and_promise_nothing"),
        ("claims/test_evidence_gaps_next_experiment.py", "test_refining_as_recommended_narrows_the_band_but_is_not_promised_to_decide"),
        ("claims/test_sensitivity_robustness_challenge.py", "test_a_challenge_never_changes_the_verdict"),
    ),
    "5. model applicability precedes evidence-bearing execution": (
        ("claims/test_quantitative_uq.py", "test_a_distribution_that_leaves_the_validated_domain_is_unknown_not_truncated"),
        ("claims/test_external_evidence.py", "test_a_pinned_measurement_falls_short_for_exactly_the_stated_reason"),
    ...
    "6. verification does not become validation": (
        ("claims/test_external_evidence.py", "test_offered_external_evidence_never_changes_the_verdict_or_the_levels"),
        ("claims/test_evidence_policy.py", "test_policy_findings_name_their_authoritative_record"),
    ...
    "7. solver agreement does not prove real-world correctness": (
        ("claims/test_quantitative_uq.py", "test_numerical_uq_cannot_satisfy_model_form"),
    ...
    "8. missing uncertainty never becomes zero": (
        ("claims/test_quantitative_uq.py", "test_every_rule_failure_is_unknown_never_zero"),
        ("claims/test_quantitative_uq.py", "test_combined_uncertainty_cannot_masquerade_as_a_single_channel"),
        ("claims/test_external_evidence.py", "test_a_benchmark_is_admissible_only_when_trusted_and_exactly_applicable"),
    ),
    "9. missing discrepancy never becomes zero": (
        ("claims/test_evidence_gaps_next_experiment.py", "test_each_insufficiency_is_classified_by_its_cause"),
    ...
    "10. missing boundary conditions are never silently defaulted": (
        ...
        ("claims/test_evidence_gaps_next_experiment.py", "test_supplying_the_recommended_input_closes_the_gap"),
    ...
    "11. contradiction requires admissible evidence": (
        ("claims/test_sensitivity_robustness_challenge.py", "test_nothing_weak_or_undeclared_can_weaken_a_claim"),
        ("claims/test_sensitivity_robustness_challenge.py", "test_admissible_external_evidence_that_disagrees_weakens_and_weak_evidence_cannot"),
    ...
    "12. evidence stays bound to its exact context and decision": (
        ...
        ("claims/test_evidence_policy.py", "test_changing_the_policy_changes_claim_identity_and_the_charter"),
    ),
    "13. higher risk never requires less evidence within a policy family": (
        ("claims/test_evidence_policy.py", "test_more_risk_never_requires_less_evidence_within_a_profile"),
        ("claims/test_evidence_policy.py", "test_higher_risk_under_one_profile_never_yields_a_stronger_verdict"),
        ("claims/test_evidence_policy.py", "test_a_higher_risk_policy_that_demands_less_is_refused"),
    ),
    "14. a policy cannot grant scientific evidence": (
        ("claims/test_evidence_policy.py", "test_no_decision_context_ever_strengthens_a_verdict"),
        ("claims/test_evidence_policy.py", "test_a_policy_cannot_grant_what_the_run_lacks"),
        ("claims/test_evidence_policy.py", "test_the_effective_claim_only_ever_gains_requirements"),
    ),
}
