...
benchmarks/core_v4_false_confidence/BATCH5_THRESHOLD_PROTOCOL.json. Recorded as strict xfails before the fix.
"""
...
AUDITED = pytest.mark.xfail(strict=True, reason="reproduced before batch 5; fixed in batch 5")
