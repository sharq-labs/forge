...
def migrate_authorized_run(
    ...
    upgraded = made.to_dict()
    ready = bool(
        made.system_uncertainty
        and made.system_verification
    ...
    return MigrationResult(
        ...
        notes=(
            ...
            if ready
                ...
                "authorities (system UQ, independent verification, semantic "
                "snapshot); preserve it as historical evidence and re-run "
