...
ELECTROTHERMAL = SystemBoundary(
    ...
    summary=(
        ...
        "body it dissipates into, run to a quasi-static end-of-interval fixed "
        "point: each body is integrated over its declared duration with the "
        "dissipation at the resistance of its END-of-interval temperature, "
        "held constant across the interval, so a transient in which R moves "
        "is approximated rather than resolved. One credibility evidence "
        "report per stage. "
